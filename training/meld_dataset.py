...
class MELDDataset:
    def __init__(self,csv_path, video_dir):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('bert-base-uncased', use_auth_token=False)
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Map sentiment and emotion labels to integers
...
def collate_fn(batch):
    batch = list(filter(None, batch))  # Filter out None values
